...
/**
 * Architectural tests for JPA entity and repository patterns in the catbox application. Tests
 * verify that entities and repositories follow JPA best practices.
 */
  ...
  void entitiesIdFieldsShouldBeAnnotatedWithId() {
    ArchRule rule =
        fields()
            ...
            .haveName("id")
            .should()
            .beAnnotatedWith(jakarta.persistence.Id.class)
  ...
  void tableAnnotationShouldBeUsedForEntities() {
    ArchRule rule =
        classes()
            ...
            .areAnnotatedWith(jakarta.persistence.Entity.class)
            .should()
            .beAnnotatedWith(jakarta.persistence.Table.class)
