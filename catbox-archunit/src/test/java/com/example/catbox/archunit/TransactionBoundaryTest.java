...
/**
 * Architectural tests for transaction boundaries in the catbox application. Tests verify that
 * services properly handle transactional operations.
 */
  ...
  void serviceMethodsModifyingDataShouldBeTransactional() {
    ArchRule rule =
        methods()
            ...
            .arePublic()
            .and()
            .haveNameMatching("(create|update|delete|save|remove).*")
            .should()
  ...
  void controllersShouldNotBeTransactional() {
    ArchRule rule =
        classes()
            ...
            .because(
                "Controllers should not manage transactions directly - this should be done in the service layer");
  ...
  void serviceClassesShouldBeAnnotatedWithTransactional() {
    ArchRule rule =
        classes()
            ...
            .beAnnotatedWith(org.springframework.transaction.annotation.Transactional.class)
            .because(
                "Service classes should typically be annotated with @Transactional at class or method level");
