...
/**
 * Entity representing processed messages tracked by consumer group. Used for deduplication of Kafka
 * messages to prevent duplicate processing.
 */
@Entity
@Table(
...
public class ProcessedMessage {
   ...
   */
  public ProcessedMessage(final String correlationId, final String consumerGroup) {
