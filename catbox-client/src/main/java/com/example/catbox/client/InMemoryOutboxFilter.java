 ...
 * correlation IDs using a thread-safe concurrent set.
 *
 ...
 * </ul>
 *
 * <p>For production use cases where state must survive restarts, consider
 * using a persistent implementation backed by a database or distributed
 * cache.
 */
@Slf4j
public final class InMemoryOutboxFilter implements OutboxFilter {
    ...
    /**
     * Clears all tracked correlation IDs. Useful for testing or when
     * implementing a time-based cleanup strategy.
     */
    public void clear() {
        processedIds.clear();
