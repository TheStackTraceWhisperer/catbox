 ...
 * <p>Tests:
 * <ul>
 *   <li>Happy path: messages are processed successfully</li>
 *   <li>Deduplication: duplicate messages are filtered out by OutboxFilter</li>
 *   <li>Multiple messages: multiple unique messages are all processed</li>
 *   <li>Database persistence: processed messages are tracked in the database</li>
 * </ul>
 */
@SpringBootTest
@Testcontainers
class OrderProcessorE2ETest {
    ...
    @Container
    static final MSSQLServerContainer<?> mssqlContainer = new MSSQLServerContainer<>(
    ...
    void testHappyPath_SingleMessage_ProcessedSuccessfully() throws Exception {
        ...
        OrderCreatedPayload payload = new OrderCreatedPayload(
            1L, "Alice", "Widget", new BigDecimal("99.99"), "PENDING"
        );
    ...
    void testDeduplication_DuplicateMessages_ProcessedOnlyOnce() throws Exception {
        ...
        String correlationId = UUID.randomUUID().toString();
        OrderCreatedPayload payload = new OrderCreatedPayload(
            2L, "Bob", "Gadget", new BigDecimal("149.99"), "PENDING"
        );
        String message = objectMapper.writeValueAsString(payload);
    ...
    void testMixedScenario_UniqueAndDuplicateMessages() throws Exception {
        ...
        OrderCreatedPayload payload1 = new OrderCreatedPayload(
            201L, "Charlie", "Item-A", new BigDecimal("25.00"), "PENDING"
        );
        OrderCreatedPayload payload2 = new OrderCreatedPayload(
            202L, "Diana", "Item-B", new BigDecimal("35.00"), "PENDING"
        );
