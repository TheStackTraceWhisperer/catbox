...
public class AdminController {
  ...
  public String processedMessagesPage(
      ...
      @RequestParam(required = false, defaultValue = "processedAt") String sortBy,
      @RequestParam(required = false, defaultValue = "DESC") Sort.Direction direction,
      Model model) {
    ...
    model.addAttribute("consumerGroup", consumerGroup != null ? consumerGroup : "");
    model.addAttribute("correlationId", correlationId != null ? correlationId : "");
    model.addAttribute("sortBy", sortBy);
    model.addAttribute("direction", direction.name());
  ...
  public ResponseEntity<String> markUnprocessed(
      @RequestParam String correlationId, @RequestParam String consumerGroup) {
