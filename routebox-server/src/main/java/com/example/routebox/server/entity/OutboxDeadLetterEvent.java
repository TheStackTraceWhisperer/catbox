package com.example.routebox.server.entity;
...
/**
 * Entity representing events that have been moved to the dead-letter queue after exceeding the
 * maximum number of permanent failure retries.
 */
@Entity
