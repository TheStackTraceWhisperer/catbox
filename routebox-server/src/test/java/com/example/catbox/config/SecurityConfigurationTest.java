...
/**
 * Test to verify that the security configuration (SSL bundles and SASL)
 * is properly loaded from application.yml and available in the application context.
 */
...
class SecurityConfigurationTest {
    ...
    @Autowired
    private KafkaClustersConfig clustersConfig;
