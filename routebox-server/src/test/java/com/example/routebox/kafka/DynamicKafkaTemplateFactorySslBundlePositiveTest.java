...
/**
 * Tests to verify SSL bundle configuration in DynamicKafkaTemplateFactory.
 * This test uses mocked SslBundles to avoid needing actual SSL certificates.
 */
@SpringBootTest(classes = {TestKafkaOnlyApplication.class, DynamicKafkaTemplateFactorySslBundlePositiveTest.TestConfig.class})
@DirtiesContext
