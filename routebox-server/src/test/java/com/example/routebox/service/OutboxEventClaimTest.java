...
class OutboxEventClaimTest {
    ...
    void testClaimPendingEvents_claimsEventsSuccessfully() {
        ...
        assertThat(claimed).extracting(OutboxEvent::getAggregateId)
    ...
    void testClaimPendingEvents_skipsAlreadySentEvents() {
        ...
        outboxEventRepository.save(new OutboxEvent("Order", "A1", "OrderCreated", "{}"));
        OutboxEvent sentEvent = outboxEventRepository.save(new OutboxEvent("Order", "A2", "OrderStatusChanged", "{}"));
    ...
    void testClaimPendingEvents_skipsEventsInProgress() {
        ...
        outboxEventRepository.save(new OutboxEvent("Order", "A1", "OrderCreated", "{}"));
        OutboxEvent inProgressEvent = outboxEventRepository.save(new OutboxEvent("Order", "A2", "OrderStatusChanged", "{}"));
    ...
    void testClaimPendingEvents_claimsExpiredInProgressEvents() {
        ...
        outboxEventRepository.save(new OutboxEvent("Order", "A1", "OrderCreated", "{}"));
        OutboxEvent expiredEvent = outboxEventRepository.save(new OutboxEvent("Order", "A2", "OrderStatusChanged", "{}"));
