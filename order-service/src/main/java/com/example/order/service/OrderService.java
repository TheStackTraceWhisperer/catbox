...
public class OrderService {
  ...
  public Order createOrder(CreateOrderRequest request) {
    ...
    outboxClient.write("Order", savedOrder.getId().toString(), "OrderCreated", payload);
  ...
  public Order updateOrderStatus(Long orderId, String newStatus) {
    ...
    // 2. Pass metadata and the payload *object* to the client
    outboxClient.write("Order", updatedOrder.getId().toString(), "OrderStatusChanged", payload);
