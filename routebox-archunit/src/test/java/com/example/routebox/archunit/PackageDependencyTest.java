...
/**
 * Architectural tests for package dependency rules in the catbox application. Tests verify that
 * packages follow proper dependency patterns.
 */
class PackageDependencyTest {
  ...
  void commonModuleShouldNotDependOnOtherModules() {
    ArchRule rule =
        noClasses()
            .that()
            .resideInAPackage("com.example.routebox.common..")
            .should()
            .dependOnClassesThat()
            .resideInAPackage("com.example.routebox.client..")
            .orShould()
            .dependOnClassesThat()
            .resideInAPackage("com.example.routebox.server..")
            .orShould()
            .dependOnClassesThat()
            .resideInAPackage("com.example.order..")
